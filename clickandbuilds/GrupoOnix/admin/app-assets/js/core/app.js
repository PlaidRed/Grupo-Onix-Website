...
(function(window, document, $) {
    ...
    $(document).ready(function() {
        ...
        $(document).on('click','.visto',function(e){
            ...
            var externo = $(this).attr('data-ext'); //1 = si es link externo
            $.ajax({
                ...
                success: function (result) {
                    ...
                    //Reload
                    $.ajax({
                        url: ruta+'include/Notices.php?accion=notificaciones',
                        type: 'POST',
                        dataType: 'JSON',
                        error: function() {
                            console.log("Error en el reload de notificaciones.");
                        }, 
                        success: function (result) {
                            $('#cont-notificaciones').html(result.notificaciones);
