...
try{
    ...
    if ($consulta->rowCount() > 0) {
        $videos = $consulta->fetchAll(PDO::FETCH_ASSOC);
    }
              ...
              <div class="col-sm-3">
                <div class="card pull-up border-top-warning border-top-3 rounded-0">
                  <div class="card-header">
                      ...
                      <span style="margin-top: 5px;" class="badge badge-pill badge-warning"><?=date("d/m/Y",strtotime($video['fecha']));?></span>
                  </div>
                  <div class="card-content collapse show">
                      <div class="card-body p-1 text-center">
                        <a href="<?=$video['link'];?>" target="_blank">Ver Videos</a>
                      </div>
                  </div>
                </div>
              </div>
