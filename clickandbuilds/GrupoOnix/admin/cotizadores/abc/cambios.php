 ...
 */
define("PAGE_TITLE", "Edición de Cotizadores");
                              ...
                              <div class="form-body">
                                 <div class="form-group row">
                                  <label class="col-sm-2 label-control" for="titulo">Título*</label>
                                    ...
                                    <label class="col-sm-2 label-control" for="liga">Liga*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="liga" class="form-control border-primary" name="liga">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                  <label class="col-sm-2 label-control" for="user">User*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="user" class="form-control border-primary" name="user">
                                    </div>
                                    <label class="col-sm-2 label-control" for="password">Password*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="password" class="form-control border-primary" name="password">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="imagen">Imagen</label>
                                    <div class="col-sm-4">
