 ...
 */
define("PAGE_TITLE", "Edición de Excel");
                           ...
                           <div class="card-body">
                              <div class="form-body">
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="nombre">Nombre*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="nombre" class="form-control border-primary" name="nombre">
                                    </div>
                                    <label class="col-sm-2 label-control" for="imagen">Logo/Imagen</label>
                                    <div class="col-sm-4">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="excel">Excel</label>
                                    <div class="col-sm-4">
