 ...
 */
define("PAGE_TITLE", "Edición de Página Principal");
      ...
      <div class="content-wrapper">
        <div class="content-body">
          ...
          <div class="container main-container">
            <form id="frm-marca" class="form form-horizontal">
              <input name="id" type="hidden" id="id" value="3">
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <h4 class="card-title" id="horz-layout-colored-controls"><i class="ft-image"></i> BANNER</h4>
                           ...
                           <div class="card-body">
                              <div class="form-body">
                                <div class="form-group row">
                                  <label class="col-sm-2 label-control" for="home_banner_img"><i class="ft-info" data-toggle="tooltip" data-placement="top" data-original-title="MEDIDA: 1440x800px"></i>Banner*</label>
                                  <div class="col-sm-10">
                                    <div class="cont-home_banner_img">
                                      
                                    </div>
                                    <input type="file" name="home_banner_img" id="home_banner_img" class="form-control">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-2 label-control" for="home_banner_txt">Texto Banner*</label>
                                  <div class="col-sm-10">
                                    <textarea class="form-control" name="home_banner_txt" id="home_banner_txt"></textarea>
                                  </div>
                                </div>
                              </div>
                           </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <h4 class="card-title" id="horz-layout-colored-controls"><i class="ft-briefcase"></i> NUESTRA COMPAÑÍA</h4>
                           <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                           <div class="heading-elements">
                              <ul class="list-inline mb-0">
                                 <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                       ...
                       <div class="card-content collpase show">
                           <div class="card-body">
                              <div class="form-body">
                                <div class="form-group row">
                                  <label class="col-sm-3 label-control" for="home_compania_txt">Texto Nuestra Compañía*</label>
                                  <div class="col-sm-9">
                                    <textarea id="home_compania_txt" name="home_compania_txt" class="form-control"></textarea>
                                  </div>
                                </div>
                              </div>
                           </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <h4 class="card-title" id="horz-layout-colored-controls"><i class="ft-heart"></i> NUESTROS PRODUCTOS</h4>
                           <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                           <div class="heading-elements">
                              <ul class="list-inline mb-0">
                                 <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                       ...
                       <div class="card-content collpase show">
                           <div class="card-body">
                              <div class="form-body">
                                <div class="form-group row">
                                  <label class="col-sm-3 label-control" for="home_productos_txt">Texto Nuestros Productos*</label>
                                  <div class="col-sm-9">
                                    <textarea id="home_productos_txt" name="home_productos_txt" class="form-control"></textarea>
                                  </div>
                                </div>
                              </div>
                           </div>
