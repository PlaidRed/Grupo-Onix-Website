...
<head>
    ...
    <title>Grupo Onix Seguros</title>
...
<!--   You can change the black color for the filter with those colors: blue, green, red, orange       -->
    ...
    <div class="container">
        <img src="GRUPO ONIX.svg" width="250" height="250" alt="GRUPO ONIX"/>

        <h1 class="logo">
            Grupo Onix, Agente de Seguros S.A. de C.V.
        </h1>
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        
        <div class="content">
            <h4 style="color:#000000" class="motto">Bienvenido al Portal de Grupo Onix. El Portal está en construcción.</h4>
            <div class="subscribe">
                <h5 style="color:#000000" class="info-text">

        <p>Clientes (Consulta tu póliza): </p>
        <a href="https://app01.copsis.com/sio3vista/login_clientes.aspx?f1=LPxnGNqqAslh5+difquMpQ==" target="_blank"><img src="Logo SiO.png" width="250" alt="SIO"/></a>
        <p> </p>            
                    <p>rvizcaya@segurosonix.com - Ext. 104</p>
                    <p>dtrevino@segurosonix.com - Ext. 110</p>
                    <p>mambriz@segurosonix.com - Ext. 105</p>
                    <p>acruz@segurosonix.com - Ext. 106</p>
                    <p>cmedrano@segurosonix.com - Ext. 103</p>
                    <p>jtamez@segurosonix.com - Ext. 107</p>
                    <p>hvizcaya@segurosonix.com - Ext. 113</p>

                    <p> </p>
                    <p>Enlace para acceder al SIO: </p>
                    
                    <a href="http://app01.copsis.com/siov3crm/login_valida.aspx?fs=LPxnGNqqAslh5+difquMpQ==" target="_blank"><img src="Logo SiO.png" width="250" alt="SIO"/></a>
                </h5>
<!--                <div class="row">
                ...
                <h5 style="color:#000000" class="info-text">
                    <p>Grupo Ónix Agente de Seguros, S.A. de C.V.</p>
                    <p>Daniel Zambrano No. 440, Col. Chepevera, C.P. 64030 </p>
                    <p>Tel. (81) 2318-0138 al 40</p>
                </h5>
            </div>
        </div>
    </div>
