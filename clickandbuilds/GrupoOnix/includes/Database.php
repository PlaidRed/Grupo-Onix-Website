...
$databases = array(
	...
	'PRODUCCION' => array(
		'dbms' => "mysql",
		'host' => 'db5000519246.hosting-data.io',
		'name' => 'dbs498536',
		'user' => 'dbu94797',
		'password' => "0N1x_da7a8a53",
		'encoding' => 'utf8',
		'port' => '',
		'persistant' => false,
	)
...
//$pastora = new Database();

//echo("CRYPT: ".crypt("Edgar")."<br />CRYPT SALT: ".crypt("Edgar", "$2a$05$op4yhdui30oplkadfetgwui2p"));


//$pastora->table("ejemplo",array('id'=>1),'where');
?>