 ...
 */
define("PAGE_TITLE", "Edición de Avisos");
                           ...
                           <div class="card-body">
                              <div class="form-body">
                                    ...
                                    <div class="form-group row">
                                       ...
                                       <div class="col-sm-10">
                                          <textarea class="form-control border-primary" id="mensaje" name="mensaje"></textarea>
                                       </div>
                                    </div>

                                    <div class="form-group row">
                                       <label class="col-sm-2 label-control" for="pdf">PDF</label>
                                       <div class="col-sm-4">
