 ...
 */
define("PAGE_TITLE", "Edición Únete");
              ...
              <input name="id" type="hidden" id="id" value="3">
                           ...
                           <div class="card-body">
                              <div class="form-body">
                                <div class="form-group row">
                                  <label class="col-sm-2 label-control" for="unete_banner_img"><i class="ft-info" data-toggle="tooltip" data-placement="top" data-original-title="MEDIDA: 1440x800px"></i>Banner*</label>
                                  <div class="col-sm-10">
                                    <div class="cont-unete_banner_img">
                                      
                                    </div>
                                    <input type="file" name="unete_banner_img" id="unete_banner_img" class="form-control">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <label class="col-sm-2 label-control" for="unete_banner_txt">Texto Banner*</label>
                                  <div class="col-sm-10">
                                    <textarea class="form-control" name="unete_banner_txt" id="unete_banner_txt"></textarea>
                                  </div>
                                </div>
                              </div>
                           </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <h4 class="card-title" id="horz-layout-colored-controls"><i class="ft-briefcase"></i> VENTAJAS COMPETITIVAS</h4>
                           <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                           <div class="heading-elements">
                              <ul class="list-inline mb-0">
                                 <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                       ...
                       <div class="card-content collpase show">
                           <div class="card-body">
                              <div class="form-body ventajas-competitivas">

                              </div>
                              <button type="button" class="btn btn-success agregar-ventaja">
                                  <i class="la la-plus"></i> Agregar Ventaja
                               </button>
                           </div>
                       </div>
                     </div>
               ...
               <div class="row">
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-header">
                           <h4 class="card-title" id="horz-layout-colored-controls"><i class="ft-mail"></i> EMAIL</h4>
                           <a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
                           <div class="heading-elements">
                              <ul class="list-inline mb-0">
                                 <li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                       ...
                       <div class="card-content collpase show">
                           <div class="card-body">
                              <div class="form-body">
                                <div class="form-group row">
                                  <label class="col-sm-3 label-control" for="home_productos_txt">Correo al que llega el Formulario*</label>
                                  <div class="col-sm-9">
                                    <input type="email" name="unete_email" id="unete_email" class="form-control">
                                  </div>
                                </div>
                              </div>
                           </div>
