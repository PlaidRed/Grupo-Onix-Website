...
if (isset($_SESSION["onx"]["loginError"])) {
    $error = true;
    $errorNo = $_SESSION["onx"]["loginError"];
    unset($_SESSION["onx"]["loginError"]);
}
...
<html class="loading" lang="es" data-textdirection="ltr">
  <head>
    ...
    <title>Recuperar Contraseña | Administrador Grupo Onix</title>
        ...
        <div class="col-md-4 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                ...
                <div class="card-content">
                    ...
                    <div class="card-body">
                        <form id="frm-forgot" class="form-horizontal" action="#" novalidate>
                            <div id="login-info">
                            ...
                            <div class="form-group text-center">
                                <button type="submit" class="btn round btn-block btn-glow btn-bg-gradient-x-orange-yellow col-12 mr-1 mb-1">Enviar</button>    
                            </div>
                            <div class="col-md-12 float-sm-left text-center text-sm-right"><a href="index.php" class="card-link">Regresar a Inicio de Sesión</a></div>
                        </form>
                    </div>                    
                </div>
            </div>
