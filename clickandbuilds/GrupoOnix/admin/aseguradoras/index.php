 ...
 */
define("PAGE_TITLE", "Aseguradoras");
...
<html class="loading" lang="es" data-textdirection="ltr">
 ...
 <!-- name para analiticas -->
      <meta name="onix-section" content="Aseguradoras">
        ...
        <div class="content-body">
          ...
          <div class="container main-container">
            <div class="row">
              <div class="col-sm-12">
                <div class="pull-left">
                  <a class=" btn-action" href="orden.php" data-id="">
                    <button type="button" class="btn btn-primary">
                      <i class="la la-sort-numeric-asc"></i>Ordenar Aseguradoras
                    </button>
                  </a>
                </div>
