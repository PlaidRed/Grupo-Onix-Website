 ...
 */
define("PAGE_TITLE", "Edición de Productos");
                           ...
                           <div class="card-body">
                              <div class="form-body">
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="nombre">Producto*</label>
                                    <div class="col-sm-4">
                                       <input type="text" id="nombre" class="form-control border-primary" name="nombre">
                                    </div>
                                    <label class="col-sm-2 label-control" for="imagen">Imagen Principal*</label>
                                    <div class="col-sm-4">
                                      <div class="cont-img">
                                        
                                      </div>
                                       <input type="file" name="imagen" id="imagen" class="form-control border-primary">
                                    </div>
                                 </div>
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="descripcion">Descripcion*</label>
                                    <div class="col-sm-10">
                                       <input type="text" id="descripcion" class="form-control border-primary" name="descripcion">
                                    </div>
                                 </div>
                              </div>
                           </div>
