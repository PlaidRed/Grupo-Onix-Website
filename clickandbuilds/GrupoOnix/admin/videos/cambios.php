 ...
 */
define("PAGE_TITLE", "Edición de Videos");
                       ...
                       <div class="card-content collpase show">
                           <div class="card-body">
                              <div class="form-body">
                                 ...
                                 <div class="form-group row">
                                    <label class="col-sm-2 label-control" for="link">Link de YouTube*</label>
                                    <div class="col-sm-10">
                                      <input type="text" id="link" class="form-control border-primary" name="link">
                                    </div>
                                 </div>
                              </div>
                           </div>
